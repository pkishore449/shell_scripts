...
# Author: kishore
# Version: v1
# Description: Script to list all the resources in an AWS account
...
if [ $# -ne 2 ]; then
    echo "Usage: ./list_aws_resource.sh  <aws_region> <aws_service>"
    echo "Example: ./list_aws_resource.sh us-east-1 ec2"
    exit 1
fi
